...
export const AmountInput = ({ value, onChange }) => (
  <div className="floating-label-container bg-white dark:bg-slate-800 rounded-lg">
    <span className="icon-prefix font-medium text-lg text-gray-800 dark:text-gray-200">₹</span>
    <input
      type="number"
      step="0.01"
      value={value}
      ...
      required
    />
    <label htmlFor="tx-amount" className="floating-label text-gray-500 dark:text-gray-400">Amount</label>
  </div>
);