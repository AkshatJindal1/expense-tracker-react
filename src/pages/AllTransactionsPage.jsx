...
const AllTransactionsPage = ({ transactions, accounts, onNavigate, openSelectionSheet }) => {
  ...
  return (
    <>
      <div className="page active">
        <div className="sticky-top-container pt-4 px-4">
          {/* Header */}
          <div className="flex items-center justify-between">
            <div className="flex items-center flex-grow">
              <button onClick={() => onNavigate('home')} className="material-symbols-outlined mr-2">arrow_back</button>
            ...
            Object.entries(groupedTransactions).map(([dateKey, txs]) => (
              <div key={dateKey}>
                ...
                <div className="space-y-3">
                  {txs.map(tx => <TransactionCard key={tx.id} tx={tx} />)}
                </div>
              </div>
            ))
          ) : (
