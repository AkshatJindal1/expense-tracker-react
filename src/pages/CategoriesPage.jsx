        ...
        <div className="flex items-center justify-between mb-4 text-gray-800 dark:text-gray-200">
          {isSelecting ? (
            <>
              ...
              <button onClick={handleDeleteSelected} disabled={selectedIds.size === 0} className="material-symbols-outlined text-red-600 disabled:text-gray-400 dark:text-red-400 disabled:text-gray-400 dark:disabled:text-gray-600">delete</button>
            </>
          ) : (
            <>
