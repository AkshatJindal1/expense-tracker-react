        ...
        <div className="page p-4 active">
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center">
                    ...
                    <h1 className="text-2xl font-medium text-gray-800">{isEditing ? 'Edit Account' : 'Add Account'}</h1>
                </div>
                {isEditing && (
            ...
            <div className="space-y-4">
                <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Account Name" className="w-full bg-gray-100 p-3 rounded-lg"/>
                <div onClick={() => openSelectionSheet('Select Type', ['Bank', 'Credit Card', 'Wallet', 'Splitwise'], type, setType)} className="form-row cursor-pointer">
                    <span className="material-symbols-outlined">category</span>
                    <span className="form-label">Type</span>
                    <span className="form-value">{type || 'Select Type'}</span>
                </div>
            </div>
