        ...
        <div className="page p-4 active text-gray-800 dark:text-gray-200">
            <div className="flex justify-between items-center mb-4">
                <div className="flex items-center">
                    ...
                    <h1 className="text-2xl font-medium">{isEditing ? 'Edit Account' : 'Add Account'}</h1>
                </div>
                {isEditing && (
            ...
            <div className="space-y-4">
                ...
                <div
                    onClick={() => openSelectionSheet('Select Type', ['Bank', 'Credit Card', 'Wallet', 'Splitwise'], type, setType)}
                ...
                >
                    <div className="flex items-center">
                        ...
                        <span className="form-label text-gray-800 dark:text-gray-200">Type</span>
                    </div>
                    <span className="form-value text-gray-600 dark:text-gray-300">{type || 'Select Type'}</span>
                </div>
            </div>
